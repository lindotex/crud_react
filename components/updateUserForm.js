...
export default function UpdateUserForm() {
    ...
    return (
        <form action="" className="grid lg:grid-cols-2 w-4/6 gap-4" onSubmit={handleSubmit}>
            ...
            <button className="flex justify-center text-md w-full text-bold bg-yellow-400 text-white px-2 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-green-500 hover:text-gray-800">
